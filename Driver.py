...
# I used the code below to initially insert data to db and commented after it was inserted
...
def main():
    ...
    if is_authenticated():
        ...
        if choice == "Analytics":
            ...
            # now we read it from database, not csv file
            ...
            st.subheader('Model Test Accuracy Score: Chance of Diabetic Patient') 
            ...
            st.write(prediction)
        if choice == "Dashboard":
            st.subheader("Welcome to Real Time Diabetes Detection System") 
            # Cover Image
